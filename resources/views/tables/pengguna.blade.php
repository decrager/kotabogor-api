            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Pengguna1">https://pemkot.kotabogor-api.my.id/Pengguna</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Pengguna2">https://pemkot.kotabogor-api.my.id/Pengguna/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Pengguna3">https://pemkot.kotabogor-api.my.id/PenggunaCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-warning pe-none">POST</button></td>
                        <td id="Pengguna4">https://pemkot.kotabogor-api.my.id/PenggunaUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Pengguna5">https://pemkot.kotabogor-api.my.id/PenggunaDest/{id}</td>
                        <td><button class="btn btn-success float-end"
