            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Berita1">https://pemkot.kotabogor-api.my.id/Berita</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Berita2">https://pemkot.kotabogor-api.my.id/Berita/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Berita3">https://pemkot.kotabogor-api.my.id/BeritaCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-warning pe-none">POST</button></td>
                        <td id="Berita4">https://pemkot.kotabogor-api.my.id/BeritaUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Berita5">https://pemkot.kotabogor-api.my.id/BeritaDest/{id}</td>
                        <td><button class="btn btn-success float-end"
