...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::post('/AlbumUpd/{id}', [AlbumController::class, 'update']);
    ...
    Route::post('/Banner_AnnounceUpd/{id}', [Banner_AnnounceController::class, 'update']);
    ...
    Route::post('/Banner_LinkUpd/{id}', [Banner_LinkController::class, 'update']);
    ...
    Route::post('/BeritaUpd/{id}', [BeritaController::class, 'update']);
    ...
    Route::post('/DataOPDUpd/{id}', [DataOPDController::class, 'update']);
    ...
    Route::post('/FotoUpd/{id}', [FotoController::class, 'update']);
    ...
    Route::post('/LinkInfoUpd/{id}', [LinkInfoController::class, 'update']);
    ...
    Route::post('/PenggunaUpd/{id}', [PenggunaController::class, 'update']);
    ...
    Route::post('/SliderUpd/{id}', [SliderController::class, 'update']);
    ...
    Route::post('/StatisUpd/{id}', [StatisController::class, 'update']);
    ...
    Route::post('/VideoUpd/{id}', [VideoController::class, 'update']);
